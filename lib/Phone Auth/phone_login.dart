...
import 'package:font_change_md/Phone%20Auth/otp_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ElevatedButton(
        ...
        onPressed: () {
          // now, we make => when user click on sign in with phone button open the dialog box where we enter the phone number,
          myDialogBox(context);
        },
        child: Row(
          children: [
                      ...
                      : ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            await FirebaseAuth.instance.verifyPhoneNumber(
                              ...
                              //  Send OTP process is completed now we move to verify the OTP
